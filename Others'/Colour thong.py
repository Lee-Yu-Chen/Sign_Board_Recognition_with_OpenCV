    ...
    if not circles is None:
        ...
        if y > r and x > r:
            ...
            if dominant_color[2] > 100:
                ...
                if sum(zone_0_color) > sum(zone_1_color) and sum(zone_0_color) > sum(zone_2_color) and sum(zone_0_color) > sum(zone_3_color):
                    print("LEFT")
                elif sum(zone_1_color) > sum(zone_0_color) and sum(zone_1_color) > sum(zone_2_color) and sum(zone_1_color) > sum(zone_3_color):
                    print("FORWARD")
                elif sum(zone_2_color) > sum(zone_0_color) and sum(zone_2_color) > sum(zone_1_color) and sum(zone_2_color) > sum(zone_3_color):
                    print ("RIGHT")
                else:
                    print("REVERSE")
            else:
